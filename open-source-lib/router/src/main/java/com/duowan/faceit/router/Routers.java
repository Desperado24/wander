...
public class Routers {
    ...
    public static String KEY_RAW_URL = "com.duowan.faceit.router.KeyRawUrl";
    ...
    public static HashMap<String, Object> getParams(String url) {
        return getParams(Uri.parse(url));
    }
    ...
    public static HashMap<String, Object> getParams(Uri uri) {
        ...
        for (Mapping mapping : mappings) {
            if (mapping.match(path)) {
                return mapping.parseParams(uri);
            }
        }
        return null;
    }

    public static Mapping getMapping(String url) {
        return getMapping(Uri.parse(url));
    }

    public static Mapping getMapping(Uri uri) {
        initIfNeed();
        Path path = Path.create(uri);
        for (Mapping mapping : mappings) {
            if (mapping.match(path)) {
